...
class Visualization:
    ...
    def get_dist(self, col_name):
        df_state = pd.DataFrame(reg_table.objects.all().values(), columns=[col_name])
    ...
    def get_charts(self, fields):
        ...
        for field in fields:
            ...
            p = figure(title="Distribution of {}".format(field), plot_width=500, plot_height=500, tools="hover",
                       toolbar_location=None, x_range=(-0.5, 1.0), tooltips="@field: @value")
